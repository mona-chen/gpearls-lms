class CreateLmsProgramCourses < ActiveRecord::Migration[7.2]
  def change
    create_table :lms_program_courses do |t|
      ...
      # Reference to parent program (this will be filled by the parent)
      t.string :parent, null: false, index: true
      t.string :parenttype, null: false, default: "LMS Program"
      t.integer :parentfield, null: false, default: 0

      # Core fields
      t.string :course, null: false, index: true # Link to LMS Course
      t.string :course_title # Fetched field, read-only
